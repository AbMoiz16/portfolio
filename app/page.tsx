    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-white order-2 lg:order-1">
              ...
              <div className="flex space-x-6 justify-center sm:justify-start">
                <Link href="https://github.com/AbMoiz16" className="text-slate-400 hover:text-orange-500">
                ...
                <Link href="mailto:moiza7197@gmail.com" className="text-slate-400 hover:text-orange-500">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm sm:text-base text-slate-300">Client Satisfaction</div>
            </div>
            <div>
      ...
      <section id="about" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6">About Me</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="flex items-center">
                  ...
                  <span className="text-sm sm:text-base text-slate-300">Manual Testing</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-orange-500 mr-2" />
                  <span className="text-sm sm:text-base text-slate-300">Automation Testing</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-orange-500 mr-2" />
                  <span className="text-sm sm:text-base text-slate-300">API Testing</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-orange-500 mr-2" />
                  <span className="text-sm sm:text-base text-slate-300">Performance Testing</span>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 sm:p-6 text-center">
                  ...
                  <h3 className="font-semibold text-white mb-1 sm:mb-2 text-sm sm:text-base">Testing Expertise</h3>
                  <p className="text-xs sm:text-sm text-slate-300">Comprehensive testing strategies</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 sm:p-6 text-center">
                  <Code className="h-6 w-6 sm:h-8 sm:w-8 text-orange-500 mx-auto mb-3 sm:mb-4" />
                  <h3 className="font-semibold text-white mb-1 sm:mb-2 text-sm sm:text-base">Automation</h3>
                  <p className="text-xs sm:text-sm text-slate-300">Python, Selenium, PyTest</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 sm:p-6 text-center">
                  <Database className="h-6 w-6 sm:h-8 sm:w-8 text-orange-500 mx-auto mb-3 sm:mb-4" />
                  <h3 className="font-semibold text-white mb-1 sm:mb-2 text-sm sm:text-base">API Testing</h3>
                  <p className="text-xs sm:text-sm text-slate-300">POSTMAN, REST APIs</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-4 sm:p-6 text-center">
                  <Users className="h-6 w-6 sm:h-8 sm:w-8 text-orange-500 mx-auto mb-3 sm:mb-4" />
                  <h3 className="font-semibold text-white mb-1 sm:mb-2 text-sm sm:text-base">Agile/SDLC</h3>
                  <p className="text-xs sm:text-sm text-slate-300">Jira, Test Case Development</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section id="services" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <TestTube className="h-10 w-10 text-orange-500 mb-4" />
                <CardTitle className="text-white">Manual Testing</CardTitle>
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-white">Test Automation</CardTitle>
                <CardDescription className="text-slate-300">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-white">QA Consulting</CardTitle>
                <CardDescription className="text-slate-300">
      ...
      <section id="portfolio" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-white">Mobile Application Testing</CardTitle>
                <CardDescription className="text-slate-300">Emotional State Sharing Platform</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-white">ERP System Testing</CardTitle>
                <CardDescription className="text-slate-300">Business Operations Management</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-slate-300 mb-4">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-white">E-commerce Platform Testing</CardTitle>
                <CardDescription className="text-slate-300">Online Shopping Experience</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-slate-300 mb-4">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-white">Productivity Extension Testing</CardTitle>
                <CardDescription className="text-slate-300">Task Management Integration</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-slate-300 mb-4">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-white">Skills Assessment Platform</CardTitle>
                <CardDescription className="text-slate-300">Professional Evaluation System</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-slate-300 mb-4">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-orange-500 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-white">API Testing Expertise</CardTitle>
                <CardDescription className="text-slate-300">Backend Service Validation</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-slate-300 mb-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Technologies & Tools</h2>
            <p className="text-lg text-slate-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            ...
            {[
              ...
              <div key={index} className="text-center group cursor-pointer">
                <div className="bg-slate-800 rounded-lg p-4 mb-2 transition-all duration-300 group-hover:bg-orange-500/20 group-hover:scale-105 border border-slate-700">
                  <tech.icon className="h-8 w-8 text-slate-400 mx-auto group-hover:text-orange-500 transition-colors duration-300" />
                </div>
                <div className="text-sm text-slate-400 group-hover:text-orange-500 transition-colors duration-300">
                  {tech.name}
                </div>
              </div>
            ))}
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-300">Ready to ensure your software meets the highest quality standards?</p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-slate-300">moiza7197@gmail.com</span>
                </div>
                <div className="flex items-center">
                  <Phone className="h-5 w-5 text-orange-500 mr-3" />
                  <span className="text-slate-300">+92 (337) 0434823</span>
                </div>
                <div className="flex items-center">
              ...
              <div className="bg-slate-800/50 rounded-lg p-6 mb-8 border border-slate-700">
                <h4 className="font-semibold text-white mb-4">Why Choose Me?</h4>
                <ul className="space-y-2 text-sm text-slate-300">
      ...
      <footer className="bg-slate-900 text-white py-12 px-4 sm:px-6 lg:px-8 border-t border-slate-700">
        <div className="max-w-7xl mx-auto text-center">
          <div className="pt-8">
            <p className="text-slate-400">© 2025 Abdul Moiz Khan. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
